...
socket.AF_INET specifies the address family as IPV4, meaning we'll only use IPv4 addresses
socket.SOCK_STREAM specifies the socket type as TCP, this is necessary to scan services like HTTPS or SSH
...
#if the result is 0, then the connection attempt was sucessful aka port is open.
